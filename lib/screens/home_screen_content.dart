...
class _HomeScreenContentState extends State<HomeScreenContent> {
  late PageController pageController = PageController(viewportFraction: 0.85);
  bool isDrag = false;
                  ...
                  return AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      if(pageController.position.haveDimensions){
                        pageOffest=pageController.page!-index-1;
                      }
                      double gauss =
                      math.exp(-(math.pow((pageOffest.abs() - 0.5), 2) / 0.08));
                      return Transform.translate(
                        offset: Offset(-32 * gauss * pageOffest.sign, 0),
                        child: Container(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.asset(
                                    height: 30.h,
                                    fit: BoxFit.cover,
                                    alignment: Alignment(-pageOffest,0),
          ...
          child: GestureDetector(
            ...
            child: isDrag
                ? Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius:
                            BorderRadius.vertical(top: Radius.circular(15.px)),
                        color: Colors.orange),
                    child: Container(
                      width: double.infinity,
